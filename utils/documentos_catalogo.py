...
def plan_permite(plan_usuario: str, plan_requerido: str) -> bool:
    ...
    if _MODO_BETA:
        return True  # ← BETA: todos los planes permiten todo
    try:
...
def modo_beta_activo() -> bool:
    """True si el modo beta está activo (todos los documentos desbloqueados)."""
    return _MODO_BETA
