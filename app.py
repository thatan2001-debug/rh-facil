...
# ══════════════════════════════════════════════════════════════════════════════
    ...
    # Usar la pantalla nueva y unificada de generación de documentos
    from utils.pantalla_documentos import pantalla_generar
    pantalla_generar(u, st.session_state.datos_empresa)
